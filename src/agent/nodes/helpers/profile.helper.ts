...
const bilingualLanguagePrompt = 'Welcome to SchemeSaathi! Before we proceed to help you find the right government schemes, I would like to know your language preference. Which language do you prefer? Please reply with English or Hindi.\n\nस्कीमसाथी में आपका स्वागत है! आपके लिए सही सरकारी योजनाएँ ढूँढने में मदद करने से पहले, मैं आपकी भाषा पसंद जानना चाहूँगा। आप कौन सी भाषा पसंद करते हैं? कृपया English या Hindi में जवाब दें।';
...
export function detectPreferredLanguage(value: string): PreferredLanguage | null {
...
export function getPreferredLanguage(profile: ProfileData): PreferredLanguage {
    return profile.preferredLanguage === 'hindi' ? 'hindi' : 'english';
}

export function getFieldPrompt(field: ProfileField, profile: ProfileData): string {
...
export function normalizeProfileFieldValue(field: ProfileField, value: string): string | number | null {
...
export function getMissingField(profile: ProfileData): ProfileField | null {
